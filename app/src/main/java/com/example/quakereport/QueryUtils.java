    ...
    public static ArrayList<Earthquake> extractEarthquakes(String requestUrl) {
        ...
        try {
            ...
            for(int i=0;i<jsonArray.length();i++){
                ...
                JSONObject properties=child.optJSONObject("properties");
                ...
                // Extract the value for the key called "time" long time = properties.getLong("time");
                This causes a ripple effect and we need to update other places in the app as well.
                 */

                Earthquake earthquake=new Earthquake(properties.optString("mag"),properties.optString("place"),dateToDisplay,timeToDisplay,properties.optString("url"));
